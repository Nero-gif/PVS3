...
public class MovieRatings {
    ...
    public static void main(String[] args) throws IOException {
        List<Movie> movies = Files.lines(Paths.get("testdata/movies_db/input.csv"))
                .skip(1)
                .map(line -> line.split(","))
        ...
        List<Rating> ratings = Files.lines(Paths.get("testdata/movies_db/ratings.csv"))
                .skip(1)
                .map(line -> line.split(","))
